...
function BusinessCard(width, height, thickness){
    let clickX = 0;   //Used for rotating the card
...
BusinessCard.prototype.type = 'BusinessCard';

BusinessCard.prototype.loadFonts = function() {
    //Load Fonts
    let fPromise1 = document.fonts.load('12px Righteous');
    let fPromise2 = document.fonts.load('12px Roboto');
    return Promise.all([fPromise1, fPromise2]);
};

BusinessCard.prototype.buildThreeObject = function() {
...
BusinessCard.prototype.init = function() {
...
BusinessCard.prototype.update = function() {};
